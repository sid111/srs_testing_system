...
<body>
    ...
    <script>
        // --- UTILITY: Attach view & delete handlers to buttons ---
        ...
        // --- INITIAL ATTACH ---
        document.querySelectorAll("#recentReportsTable tbody tr").forEach(tr => attachRowActions(tr));
        document.querySelectorAll("#scheduledReportsTable tbody tr").forEach(tr => attachRowActions(tr));
        ...
        document.querySelectorAll(".edit-btn").forEach(btn => {
            btn.addEventListener("click", () => {
                ...
                document.getElementById("edit_generated_by").value = btn.dataset.generated_by || '';
        ...
        closeEditBtns.forEach(btn => btn.onclick = () => {
            ...
            <div class="modal-body">
                <form id="editReportForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="edit_rtype" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="edit_generated_by">
                            <option value="">Select Tester</option>
                            <?php foreach ($testers as $t): ?>
                                <option value="<?= $t['tester_id'] ?>"><?= htmlspecialchars($t['tester_name']) ?></option>
                            <?php endforeach; ?>
