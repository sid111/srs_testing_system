...
<body>
        ...
        <div class="container">
            <nav class="navbar">
                ...
                <ul class="nav-menu" id="navMenu">
                    ...
                    <li><a href="product.php">Product Catalog</a></li>S
                    <li>
                    ...
                    <table class="data-table" id="scheduledReportsTable">
                        ...
                        <tbody>
                            <?php if (count($scheduledReports) == 0): ?>
                                <tr>
                                    <td colspan="<?= $isAdminLoggedIn ? 6 : 5 ?>" style="text-align:center;">No scheduled reports</td>
                                </tr>
                            <?php else: ?>
                                        ...
                                        <?php if ($isAdminLoggedIn): ?>
                                            <td>
                                                <div class="action-buttons">
                                                    ...
                                                    <button class="action-btn delete-btn" data-id="<?= $schedule['schedule_id'] ?>">
                                                        <i class="fas fa-trash"></i> Delete
                                                    </button>
                                                </div>
                                            </td>
    ...
    <script>
        // --- UTILITY: Attach view, edit, & delete handlers to buttons ---
        function attachRowActions(row) {
            ...
            if (viewBtn) {
                viewBtn.onclick = () => {
                    window.open("api/view_report.php?id=" + viewBtn.dataset.id, "_blank");
                };
            }
            ...
            if (deleteBtn) {
                deleteBtn.onclick = () => {
                    ...
                    const isScheduled = row.closest("#scheduledReportsTable") !== null;
            ...
            if (editBtn) {
                editBtn.onclick = () => {
                    ...
                    document.getElementById("edit_rtype").value = editBtn.dataset.rtype;
                    document.getElementById("edit_format").value = editBtn.dataset.format || "";
                    document.getElementById("edit_status").value = editBtn.dataset.status;

                    // Handle visibility of 'Generated By' field
                    const generatedByGroup = document.getElementById("edit_generated_by_group");
                    if (editBtn.dataset.type === 'generated') {
                        document.getElementById("edit_generated_by").value = editBtn.dataset.generated_by || '';
                        generatedByGroup.style.display = 'block';
                    } else {
                        generatedByGroup.style.display = 'none';
                    }
        ...
        // --- INITIAL ATTACH & MODAL SETUP ---
        document.addEventListener("DOMContentLoaded", () => {
            // Attach actions to all existing rows
            document.querySelectorAll("#recentReportsTable tbody tr").forEach(attachRowActions);
            document.querySelectorAll("#scheduledReportsTable tbody tr").forEach(attachRowActions);
            ...
            editForm.addEventListener("submit", e => {
                ...
                fd.append("report_type", document.getElementById("edit_rtype").value);
                fd.append("format", document.getElementById("edit_format").value);
                fd.append("status", document.getElementById("edit_status").value);

                // Append type-specific fields
                if (editType === "generated") {
                    fd.append("report_id", document.getElementById("edit_id").value);
                    fd.append("report_name", document.getElementById("edit_name").value);
                    fd.append("generated_by", document.getElementById("edit_generated_by").value);
                } else { // 'scheduled'
                    fd.append("schedule_id", document.getElementById("edit_id").value);
                    fd.append("schedule_name", document.getElementById("edit_name").value);
                }
            ...
            <div class="modal-body">
                <form id="editReportForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="edit_rtype" name="report_type" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group" id="edit_generated_by_group">
                        ...
                        <select class="form-control" id="edit_generated_by" name="generated_by">
