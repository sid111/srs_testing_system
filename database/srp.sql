...
INSERT INTO `analytics_summary` (`id`, `label`, `value`, `type`, `created_at`) VALUES
(1, 'Overall Pass Rate', '94.7', 'percentage', '2026-01-19 18:31:52'),
(2, 'Failure Rate', '5.3', 'percentage', '2026-01-19 18:31:52'),
(3, 'Total Products Tested', '1247', 'count', '2026-01-19 18:31:52'),
(4, 'CPRI Approvals', '312', 'count', '2026-01-19 18:31:52');
...
INSERT INTO `products` (`product_id`, `name`, `category`, `voltage_rating`, `certification`, `description`, `price`, `stock`, `badge`, `featured`, `created_at`, `image`) VALUES
('ELEC-2023-001', 'HV Switchgear Panel', 'switchgear', 'hv', 'cpri', 'High voltage switchgear panel designed for industrial power distribution with advanced safety features and remote monitoring capabilities.', 125000.00, 12, 'cpri', 1, '2026-01-19 13:43:51', NULL),
('ELEC-2023-002', 'Power Capacitor Bank', 'capacitors', 'mv', 'iec', 'Three-phase power factor correction capacitor bank with automatic switching and overload protection.', 75000.00, 20, 'popular', 1, '2026-01-19 13:43:51', NULL),
('ELEC-2023-003', 'Industrial Fuse Set', 'fuses', 'lv', 'iso', 'High-breaking capacity fuses for industrial applications with time-delay characteristics.', 5000.00, 100, NULL, 0, '2026-01-19 13:43:51', NULL),
...
('PRD-003', 'Distribution Transformer 500kVA', 'transformers', 'mv', 'cpri', 'Oil-cooled distribution transformer for industrial and commercial applications.', 325000.00, 8, 'popular', 1, '2026-01-19 09:38:44', NULL),
('PRD-004', 'Motor Control Center Panel', 'panels', 'lv', 'iec', 'Custom designed motor control center with PLC integration and HMI interface.', 185000.00, 3, 'limited', 1, '2026-01-19 09:38:44', NULL),
('PRD-005', 'MV Switchgear MV-3200', 'switchgear', 'mv', 'cpri', 'Medium voltage switchgear with advanced protection relays and remote monitoring.', 275000.00, 15, 'cpri', 1, '2026-01-19 09:38:44', NULL),
('PRD-006', 'Insulation Tester Megger MIT-500', 'testing', 'hv', 'iso', 'Portable insulation resistance tester for preventive maintenance of electrical equipment.', 45000.00, 22, 'new', 1, '2026-01-19 09:38:44', NULL),
...
INSERT INTO `scheduled_reports` (`schedule_id`, `schedule_name`, `frequency`, `next_run`, `last_run`, `status`, `report_type`) VALUES
(1, 'Daily Test Summary', 'Daily', '2023-11-16 09:00:00', '2023-11-15 09:00:00', 'active', 'Daily Summary'),
(2, 'Weekly Compliance Report', 'Weekly', '2023-11-20 10:00:00', '2023-11-13 10:00:00', 'active', 'Compliance Report'),
(3, 'Monthly Performance Review', 'Monthly', '2023-12-01 08:00:00', '2023-11-01 08:00:00', 'active', 'Performance Summary'),
(4, 'Quarterly CPRI Submission', 'Quarterly', '2024-01-01 11:00:00', '2023-10-01 11:00:00', 'paused', 'CPRI Report');
...
(4, 'ELEC-2023-004', '2023-10-28', 'Control Panels', NULL, NULL, 'completed', 'Pass', 'All functions tested successfully. Communication protocols verified with multiple devices.', 1, '2026-01-19 13:44:20', 'Meera Desai'),
(5, 'ELEC-2023-005', '2023-11-02', 'Resistors', NULL, NULL, 'failed', 'Fail', 'Failed tolerance test on resistors R3 and R7. Requires recalibration or replacement.', 1, '2026-01-19 13:44:20', 'Rajesh Kumar'),
(6, 'ELEC-2023-006', '2023-11-07', 'Testing Equipment', NULL, NULL, 'in-progress', 'In Progress', 'Accuracy testing in progress. DC voltage measurements completed, AC testing underway.', 1, '2026-01-19 13:44:20', 'Dr. Anil Sharma'),
(7, 'ELEC-2023-007', '2023-10-20', 'Switchgear', NULL, NULL, 'completed', 'Pass', 'All protection functions tested successfully. Trip timing within specified limits.', 1, '2026-01-19 13:44:20', 'Meera Desai'),
(8, 'ELEC-2023-008', '2023-11-12', 'Power Equipment', NULL, NULL, 'pending', 'Pending', 'Awaiting arrival of specialized test equipment for transient response testing.', 1, '2026-01-19 13:44:20', 'Meera Desai'),
(11, 'ELEC-2023-005', '2026-01-21', 'Safety', 'Load Test', NULL, 'in-progress', 'In Progress', NULL, 2, '2026-01-21 16:08:39', 'Arun Verma');
